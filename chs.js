...
var cnItems = {
    ...
    'limited time span': '限定时间内',
    'Quarantine Breach Detected': '检测到隔离漏洞',
    'Real time quarantine monitoring has picked up an unknown number of files executing cracking functions!': '实时隔离监控已检测到，执行破解功能的，未知数量的文件！',
    ...
    'Parallelization': '并行',
    'is available': '可用',
    'Flash Drive Utilization': '闪存驱动器利用率',
    'Add disk (': '增加磁盘 (',
    'New core online; auxillary': '新的内核网络; 辅助的',
    'task processing': '任务处理',
    'HDD Usage': '硬盘使用',
    'Additional': '额外',
    'default': '默认',
    'mounted and initialized': '安装并初始化',
    'Clock Speed Sync': '时钟速度同步',
    'testing': '测试',
    'Threat Database': '威胁数据库',
    'Threat level (': '威胁等级 (',
    'conversion complete': '转换完成',
    'Disk fabrication and': '磁盘制造和',
    'quarantine zone': '隔离区',
    'Lookahead Compression': '超前压缩',
    'Solid State Drives': '固态硬盘',
    'm.2 Allocation': 'm.2分配',
    'Virtualization': '虚拟化',
    'File System Exploitation': '文件系统开发',
    'Open Source Databases': '开源数据库',
    'successful': '成功',
    'Password cipher': '密码加密',
    '; all files accounted for': '; 所有文件都有记录',
    'Cloud Storage': '云存储',
    'Defragmentation': '碎片整理',
    'GPU Threading': 'GPU线程',
    'Drive Arrays': '磁盘阵列',
    'Hardware Reclamation': '硬件回收',
    '': '',
    '': '',
    '': '',
    '': '',
